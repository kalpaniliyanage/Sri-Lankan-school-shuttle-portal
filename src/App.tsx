        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 font-extrabold font-mono tracking-wider uppercase">
              C# WPF SQLite Desktop Interface
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <aside className="w-full md:w-64 bg-slate-900 border-r border-slate-800/80 flex flex-col text-slate-300 shrink-0 select-none pb-6 md:pb-0 no-print">
          <div className="px-4 py-3.5 border-b border-slate-800/50 flex items-center gap-2 bg-slate-950/20">
            ...
            <span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest font-mono">SQLite Server Engine Connected</span>
          </div>
          ...
          <nav className="flex-1 p-3.5 space-y-1 font-semibold text-xs">
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all cursor-pointer ${
                activeTab === 'dashboard' ? 'bg-amber-400 text-slate-950 font-bold shadow-md' : 'hover:bg-slate-800/80 text-slate-400 hover:text-slate-200'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all cursor-pointer ${
                activeTab === 'students' ? 'bg-amber-400 text-slate-950 font-bold shadow-md' : 'hover:bg-slate-800/80 text-slate-400 hover:text-slate-200'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all cursor-pointer ${
                activeTab === 'staff' ? 'bg-amber-400 text-slate-950 font-bold shadow-md' : 'hover:bg-slate-800/80 text-slate-400 hover:text-slate-200'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all cursor-pointer ${
                activeTab === 'vehicles' ? 'bg-amber-400 text-slate-950 font-bold shadow-md' : 'hover:bg-slate-800/80 text-slate-400 hover:text-slate-200'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all cursor-pointer ${
                activeTab === 'invoices' ? 'bg-amber-400 text-slate-950 font-bold shadow-md' : 'hover:bg-slate-800/80 text-slate-400 hover:text-slate-200'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all cursor-pointer ${
                activeTab === 'reports' ? 'bg-amber-400 text-slate-950 font-bold shadow-md' : 'hover:bg-slate-800/80 text-slate-400 hover:text-slate-200'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all cursor-pointer ${
                activeTab === 'sql' ? 'bg-emerald-600 text-white font-bold shadow-md' : 'hover:bg-slate-800/80 text-slate-400 hover:text-slate-200'
              }`}
            >
          ...
          <div className="p-4 border-t border-slate-800/50 text-[10px] text-slate-500 space-y-1.5 mt-auto">
            <div>WPF .NET Core Desktop Interface</div>
            <div>Database Engine: SQLite v3.42</div>
            <div>© 2026 Transport Administration</div>
          </div>
        </aside>
