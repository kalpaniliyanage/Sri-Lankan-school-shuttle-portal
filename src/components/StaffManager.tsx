...
import { playTap, playWarning } from '../utils/audio';
                                    ...
                                    <tr key={d.DriverID} className="hover:bg-slate-800/40 transition-colors">
                                        ...
                                        <td className="p-4 text-center">
                                            <div className="flex items-center justify-center gap-1.5">
                                                ...
                                                <button onClick={() => { playTap(); if (confirm(`Remove driver ${d.Name} from active duty rosters?`)) onDeleteDriver(d.DriverID); }} className="p-2 hover:bg-rose-500/10 text-rose-400 hover:text-rose-300 rounded-lg transition-colors cursor-pointer" title="Delete Profile">
                                    ...
                                    <tr key={c.ConductorID} className="hover:bg-slate-800/40 transition-colors">
                                        ...
                                        <td className="p-4 text-center">
                                            <div className="flex items-center justify-center gap-1.5">
                                                ...
                                                <button onClick={() => { playTap(); if (confirm(`Remove conductor ${c.Name} from active duty rosters?`)) onDeleteConductor(c.ConductorID); }} className="p-2 hover:bg-rose-500/10 text-rose-400 hover:text-rose-300 rounded-lg transition-colors cursor-pointer" title="Delete Profile">
                                                    <Trash2 className="w-4 h-4" />
                                                </button>
                                            </div>
                                        </td>
