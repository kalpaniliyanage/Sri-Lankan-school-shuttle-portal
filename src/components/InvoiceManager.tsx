...
import { 
  ...
  QrCode, ShieldAlert, Sparkles, User, Landmark
} from 'lucide-react';
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-xl w-full overflow-hidden my-8 border border-slate-200">
              ...
              <div className="flex items-center justify-between p-4 bg-slate-950 text-white no-print">
                ...
                <div className="flex items-center gap-2">
                  <button 
                    ...
                    className="bg-amber-400 hover:bg-amber-500 text-slate-950 font-bold px-3 py-1.5 rounded-lg text-xs inline-flex items-center gap-1.5 transition-colors cursor-pointer shadow-md"
                  >
              ...
              <div className="p-8 bg-white text-slate-800" id="printable-receipt-content">
                <div className="border-2 border-slate-800 p-6 space-y-6">
                  ...
                  {/* Footer message */}
                  <div className="text-center text-[10px] text-slate-400 pt-4 border-t border-dashed border-slate-200 italic font-medium">
                    This is a secure, boarding pass-enabled invoice generated for transport safety.
                  </div>
                </div>
              </div>
            </div>
