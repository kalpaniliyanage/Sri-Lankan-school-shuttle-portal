                ...
                {filteredVehicles.map((vehicle) => {
                    ...
                    return (
                        <div
                            ...
                            className={`border rounded-2xl overflow-hidden shadow-lg flex flex-col justify-between transition-all hover:scale-[1.01] bg-slate-950/40 ${isOverloaded ? 'border-rose-500/50 bg-rose-950/10' : 'border-slate-800/80 hover:border-slate-700/80'
                                }`}
                        >
                            {/* Cover Image */}
                            ...
                            <div className="p-5 flex-1 flex flex-col justify-between">
                                <div>
                                    <div className="flex items-start justify-between">
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <button
                                                onClick={() => { playTap(); if (confirm(`Deregister vehicle ${vehicle.RegNo} from active fleet database?`)) onDeleteVehicle(vehicle.VehicleID); }}
                                ...
                                <div className="mt-5 pt-4 border-t border-slate-800 space-y-1.5">
                                    ...
                                    <div className="w-full bg-slate-900 rounded-full h-2.5 overflow-hidden border border-slate-800">
                                        <div
                                            className={`h-full rounded-full transition-all duration-500 ${isOverloaded ? 'bg-gradient-to-r from-rose-500 to-red-600' :
